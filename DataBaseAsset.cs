    ...
    internal class DataBaseAsset
    {
        ...
        async public void ProtectedConnection(MainWindow cl)
        {
            ...
            await Task.Run(() =>
           {
               ...
               else MessageBox.Show("Нет данных о пользователеь (либо о Шиптор, что врядли, если ты првильно все установил)! Перейди в Настройки и внеси их! ЭТО ВАЖНО и это тебе не шутки!");
